...
RSpec.describe SemanticScholarWork do
  it 'exists' do
    data = {
      paperId: '22d840026482e82dce65c5d0f91eb72b7b7bba1e',
      externalIds: {
        MAG: '2792655768',
      ...
      url:
        'https://www.semanticscholar.org/paper/22d840026482e82dce65c5d0f91eb72b7b7bba1e',
      title:
      ...
      openAccessPdf: {
        url:
          'http://manuscript.elsevier.com/S1359836817339781/pdf/S1359836817339781.pdf',
        status: 'HYBRID'
      },
      fieldsOfStudy: ['Materials Science'],
      s2FieldsOfStudy: [
        { category: 'Materials Science', source: 'external' },
