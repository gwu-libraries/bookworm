...
RSpec.describe Work, type: :model do
  ...
  describe 'methods' do
    it 'returns a hash in tree format of citations and references' do
      ...
      main_investigation_main_work =
        FactoryBot.create(
          :work,
          investigation_id: main_investigation.id,
          root_work: true
        )
      ...
      5.times do
        reference =
          FactoryBot.create(:work, investigation_id: main_investigation.id)
      ...
      references.each do |reference|
        FactoryBot.create(
          ...
          citation_id: main_investigation_main_work.id
        )
      end
      ...
      citations.each do |citation|
        FactoryBot.create(
          :connection,
          reference_id: main_investigation_main_work.id,
