  ...
  var _e = (function (n) {
    ...
    (w.attr = function (e, t) {
      ...
      var n = D.attrHandle[t.toLowerCase()],
        r = n && J.call(D.attrHandle, t.toLowerCase()) ? n(e, t, !F) : undefined
      return r !== undefined
        ? r
        : S.attributes || !F
          ? e.getAttribute(t)
  ...
  Te.ajaxSetup({
    ...
    Te.each(['top', 'left'], function (e, n) {
      Te.cssHooks[n] = M(be.pixelPosition, function (e, t) {
        if (t) return (t = H(e, n)), gt.test(t) ? Te(e).position()[n] + 'px' : t
      })
    }),
...
;(hljs.LANGUAGES.ruby = (function () {
  ...
  (function (n) {
    ...
    function re(e) {
      var t = e.sTableId,
        n = e.aanFeatures.i,
        r = B('<div/>', { class: e.oClasses.sInfo, id: n ? null : t + '_info' })
      return (
        n ||
